...
class EachPostScreen extends StatefulWidget {
  int? postId;
  int? groupId;
  String mode;
  ...
  @override
  State<EachPostScreen> createState() => _EachPostScreenState();
}

class _EachPostScreenState extends State<EachPostScreen> {
                                                        ...
                                                        children: [
                                                          ...
                                                          Row(
                                                            children: [
                                                                                ...
                                                                                children: [
                                                                                  TextField(
                                                                                    ...
                                                                                    decoration: InputDecoration(
                                                                                        hintText: "대댓글을 입력해주세요", hintStyle: TextStyle(color: Colors.grey[500]), border: InputBorder.none),
                                                                                    maxLines: 3,
                                                                                    maxLength: 1000,
                                                                                  ),
                                                                                  Align(
                                                              ...
                                                              Visibility(
                                                                visible: snapshot.data!['amIOwner'] || parentComment['amIWriter'],
                                                                child: Row(
                                                                  children: [
                                                                    TextButton(
                                                                        onPressed: () {
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      children: [
                                                                        Visibility(
                                                                          visible: snapshot.data!['amIOwner'] || childCommentList[i]['amIWriter'],
                                                                          child: Row(
                                                                            children: [
                                                                              TextButton(
                                                                                  onPressed: () {
